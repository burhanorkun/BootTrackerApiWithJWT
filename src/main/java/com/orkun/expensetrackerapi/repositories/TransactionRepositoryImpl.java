...
import com.orkun.expensetrackerapi.domain.Transaction;
...
public class TransactionRepositoryImpl implements TransactionRepository {
    ...
    private static final String SQL_FIND_ALL =
            "SELECT TRANSACTION_ID, CATEGORY_ID, USER_ID, AMOUNT, NOTE, TRANSACTION_DATE FROM ET_TRANSACTIONS " +
    ...
    public Transaction findById(Integer userId, Integer categoryId, Integer transactionId)
        ...
        try {
            return jdbcTemplate.queryForObject(SQL_FIND_BY_ID,
                    new Object[]{userId, categoryId, transactionId}, transactionRowMapper);
        }catch (Exception e) {
